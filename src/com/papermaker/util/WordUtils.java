...
//       设置中文字体
     ...
     * @throws com.lowagie.text.DocumentException
     */
    public void insertContext(String contextStr,int fontsize,int fontStyle) throws DocumentException{
        // 正文字体风格
     ...
     * @throws com.lowagie.text.DocumentException
     */
    public void insertImg(String imgUrl) throws MalformedURLException, IOException, DocumentException{
//       添加图片
